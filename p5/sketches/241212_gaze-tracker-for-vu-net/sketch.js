...
function preload(){
regFont = loadFont ('/24-12-gazeTrackerForVuNet/JetBrainsMono-Light.ttf'); 
newImg = loadImage('/24-12-gazeTrackerForVuNet/new.png'); 
oldImg = loadImage('/24-12-gazeTrackerForVuNet/old.png'); 
}
...
fill(50);
ellipse(width - 100, 100, 40, 40); // Top right
ellipse(100, 100, 40, 40); // Top left
ellipse(width - 100, height - 100, 40, 40); // Bottom right
ellipse(100, height - 100, 40, 40); // Bottom left
ellipse(width / 2, height/2, 40, 40); // Center top
ellipse(width / 2, height/2, 40, 40); // Center bottom
//ellipse(width / 2, height / 2, 40, 40); // Center
}
