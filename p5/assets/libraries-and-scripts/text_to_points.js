...
function convertLetterToPoints(string, xPos, yPos, maxWidth = Infinity, maxHeight = Infinity, gridSize = 3, fontSize = 24, font = "Arial", horAlignment = "LEFT", verAlignment = "TOP") {
  ...
  text(string, xPos, yPos, maxWidth, maxHeight);
